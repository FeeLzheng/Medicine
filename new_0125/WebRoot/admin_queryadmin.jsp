            ...
            <td class="mm">
                ...
                <s:if test="#districtCount==0">
                   <s:iterator id="item" value="allMedicine2">
                    ...
                    <a  href=admin_queryAdd.action?M_name=${item.getM_name()}>请点击具体内容</a>       
                </s:iterator>
                </s:if>
                <s:else>
                    药品信息：
                        ...
                        <tbody>
                            <s:iterator id="district" value="allDistrict2" status="status">
                                <tr>
                                    ...
                                    <td>
                                        <a  href=admin_queryAdd.action?id=${district.getId()}&M_name=${district.getM_name()}&D_company=${district.getD_company()}&D_district=${district.getD_district()}&D_form=${district.getD_form()}&D_phone1=${district.getD_phone1()}&D_email1=${district.getD_email1()}&D_phone2=${district.getD_phone2()}&D_email2=${district.getD_email2()}>具体内容</a>
                                        &nbsp;&nbsp;
