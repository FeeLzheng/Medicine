                      ...
                      <table border="1" width="100%" align="center">
                        <thead>
                            <tr>
                                ...
                                <th width="13%" style="font-weight: normal;"><strong><font size="2">时间</font></strong></th>
                                <th width="32%" style="font-weight: normal;"><strong><font size="2">更改前</font></strong></th>
                                <th width="33%" style="font-weight: normal;"><strong><font size="2">更改后</font></strong></th>                                
                                <th width="9%" style="font-weight: normal;"><strong><font size="2">位置</font></strong></th>
                                <th width="4%" style="font-weight: normal;"><strong><font size="2">操作</font></strong></th>
