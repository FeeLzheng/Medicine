    ...
    <table width="90%" align="center" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td class="mm">
                ...
                <s:iterator id="district_M" value="allDistrict20" status="status">
                ...
                <s:else>
                    ...
                    <table border="1" width="95%" align="center">
                        ...
                        <tbody>
                            <s:iterator id="district" value="allDistrict20" status="status">
                                <tr>
                                    <td>${status.count}</td>
                                    ...
                                    <td>
                                      ...
                                      <a  href=admin_managerEdit1.action?id=${district.getId()}&M_name=${district.getM_name()}&D_company=${district.getD_company()}&D_form=${district.getD_phone1()}&D_phone1=${district.getD_phone1()}&D_email1=${district.getD_email1()}&D_phone2=${district.getD_phone2()}&D_email2=${district.getD_email2()}>修改</a> 
                                        &nbsp;&nbsp;
