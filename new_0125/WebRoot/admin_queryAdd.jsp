...
function click26(){ 
var O_info=document.getElementById("Q_info"); 
var ti1=document.getElementById("ti26");
O_info.value=O_info.value+'  '+ti1.value+'--'+"建议参考说明书：成人：餐时或后1小时内口服1片。如果有一餐未进或食物中不含脂肪，则可省略一次服药。";
}

function click27(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("ti27");
O_info.value=O_info.value+'  '+t1.value;
}
function click28(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("ti28");
O_info.value=O_info.value+'  '+t1.value;
}
function click29(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("ti29");
O_info.value=O_info.value+'  '+t1.value;
}
function click30(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("ti30");
O_info.value=O_info.value+'  '+t1.value;
}
function click31(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("ti31");
O_info.value=O_info.value+'  '+t1.value;
}
function click32(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("ti32");
O_info.value=O_info.value+'  '+t1.value;
}
function click33(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("ti33");
O_info.value=O_info.value+'  '+t1.value;
}
function click34(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("ti34");
O_info.value=O_info.value+'  '+t1.value;
}
...
O_info.value=O_info.value+'  '+t1.value+'--'+"标准解答：服用硫酸氨基葡萄糖出现疗效波动，可能有如下几个方面的原因：1环境或其他原因导致的疾病进展（恶化）。由于受到饮食或者风寒刺激、过度运动或者感染、炎症导致病情恶化特别是阶段性的症状加重，表现为治疗效果的反复。2服药方式改变。硫酸氨基葡萄糖主要是通过改善关节软骨的功能来发挥治疗作用的，这一过程需要长时间的积累、足量长期服用硫酸氨基葡萄糖才能获得效果，任何降低剂量、停药或者改变服药方式的行为都有可能影响硫酸氨基葡萄糖的疗效。3阶段性的症状反复并不代表药物的疗效下降。硫酸氨基葡萄糖作为一种改善病情的抗骨关节药物，其与一般的镇痛麻醉药物最大的不同在于其针对的是骨关节炎疾病的核心病理改变--关节软骨退变（所以说它是一种治本的药物而非像镇痛药那样治标不治本）。硫酸氨基葡萄糖主要的疗效指标为保护软骨、防止关节结构破坏。关节软骨的退变程度与患者自觉症状（如疼痛、功能障碍）没有必然联系，需要通过X光或者核磁共振（MRI）等影像学技术手段客观评价。";
}
function clic6(){ 
var O_info=document.getElementById("Q_info"); 
...
function clic16(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t16");
O_info.value=O_info.value+'  '+t1.value+'--'+"建议参考说明书：口服，最好在进餐时服用，一次1-2粒，一日3次，连续服用4-12周或根据需要延长，每年重复治疗2-3次。";
}

function clic26(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t26");
O_info.value=O_info.value+'  '+t1.value;
}
function clic27(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t27");
O_info.value=O_info.value+'  '+t1.value;
}
function clic28(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t28");
O_info.value=O_info.value+'  '+t1.value;
}
function clic29(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t29");
O_info.value=O_info.value+'  '+t1.value;
}
function clic30(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t30");
O_info.value=O_info.value+'  '+t1.value;
}
function clic31(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t31");
O_info.value=O_info.value+'  '+t1.value;
}
function clic32(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t32");
O_info.value=O_info.value+'  '+t1.value;
}
function clic33(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t33");
O_info.value=O_info.value+'  '+t1.value;
}
function clic34(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("t34");
O_info.value=O_info.value+'  '+t1.value;
}
...
function clico26(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to26");
O_info.value=O_info.value+'  '+t1.value;
}
function clico27(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to27");
O_info.value=O_info.value+'  '+t1.value;
}
function clico28(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to28");
O_info.value=O_info.value+'  '+t1.value;
}
function clico29(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to29");
O_info.value=O_info.value+'  '+t1.value;
}
function clico30(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to30");
O_info.value=O_info.value+'  '+t1.value;
}
function clico31(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to31");
O_info.value=O_info.value+'  '+t1.value;
}
function clico32(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to32");
O_info.value=O_info.value+'  '+t1.value;
}
function clico33(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to33");
O_info.value=O_info.value+'  '+t1.value;
}
function clico34(){ 
var O_info=document.getElementById("Q_info"); 
var t1=document.getElementById("to34");
O_info.value=O_info.value+'  '+t1.value;
}
...
<tr><td><input type="button" id="ti26" value="咨询用法用量" onclick="click26()"></td>
</tr>
<tr><td>---------------------------------------------------------------------------------------------------------------------</td></tr>
...
<tr><td><input type="button" id="t9" value="咨询硫酸氨基葡萄糖胶囊伊索佳)胶囊可以剥开吃吗？" onclick="clic9()"><input type="button" id="t10" value="咨询糖尿病人能否服用硫酸氨基葡萄糖胶囊(伊索佳)？" onclick="clic10()"> </td>
</tr>
...
<tr><td><input type="button" id="t16" value="咨询用法、用量、疗程" onclick="clic16()">
</tr>
<tr><td>--------------------------------------------------------------------------------------------------</td></tr>
</s:if>
