            ...
            <td class="mm">
                ...
                <s:if test="#districtCount==0">
                   <s:iterator id="item" value="allMedicine2">
                    ...
                    <a  href=admin_ComplainAdd.action?M_name=${item.getM_name()}>请点击具体内容</a>       
                </s:iterator>
                </s:if>
                <s:else>
                    药品信息：
                        ...
                        <tbody>
                            <s:iterator id="district" value="allDistrict2" status="status">
                                <tr>
                                    ...
                                    <td>
                                        <a  href=admin_ComplainAdd.action?id=${district.getId()}&M_name=${district.getM_name()}&D_district=${district.getD_district()} >具体内容</a>
                                        &nbsp;&nbsp;
