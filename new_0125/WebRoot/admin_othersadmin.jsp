        ...
        <tr>
            ...
            <td class="mm">
                ...
                <s:iterator id="item" value="allMedicine2">
                    ...
                    <a  href=admin_othersAdd.action?M_name=${item.getM_name()}>请点击具体内容</a>       
                </s:iterator>
                </s:if>
                <s:else>
                    药品信息：
                            ...
                            <s:iterator id="district" value="allDistrict2" status="status">
                                <tr>
                                   ...
                                   <td>${district.getD_company()}</td>
                                    <td>
                                        <a  href=admin_othersAdd.action?id=${district.getId()}&M_name=${district.getM_name()}&D_district=${district.getD_district()}&D_company=${district.getD_company()} >具体内容</a>
                                        &nbsp;&nbsp;
